...
Searches parsed with [Bio::SearchIO](https://metacpan.org/pod/Bio::SearchIO) are organized as follows _(see [SearchIO HOWTO](../howtos/SearchIO.md) for much more detail)_:
